...
def main():
    ...
    project_json = parser.create_project_json(
        owner='void-panda', #dont forget to change this to your github username
        ...
        repo_url='https://github.com/void-panda/portfolio', #dont forget to change this to your github repo url
        live_url='https://void-panda.vercel.app', #dont forget to change this to your live website url or leave it blank if you dont have one
